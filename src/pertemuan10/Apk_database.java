 ...
 * @author DEWANET
 */
public class Apk_database extends javax.swing.JFrame {
    ...
    public Apk_database() throws SQLException {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Apk_database.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Apk_database.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Apk_database().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Apk_database.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
